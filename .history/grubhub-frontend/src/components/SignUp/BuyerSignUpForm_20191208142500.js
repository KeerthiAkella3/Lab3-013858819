...
import { buyerSignupMutation } from './../../Mutations/SignupLoginProfileMutations'
    ...
    submitBuyerSignUp = (e) => {
        ...
        this.props.mutate({ variables: data })
            .then(res => {
                ...
                console.log(res);
                swal(res.data.buyerSignup.responseMessage + "\n Try logging in");
...
BuyerProfileForm = graphql (buyerSignupMutation) (BuyerProfileForm)
